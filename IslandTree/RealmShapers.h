...
public:
    ...
    void inorderTraversal(const std::vector<RealmShaper>& tree, int index, std::vector<std::string>& result);
    std::vector<std::string> preOrderTraversal(int index);
    void preorderTraversal(const std::vector<RealmShaper>& tree, int index, std::vector<std::string>& result);
    std::vector<std::string> postOrderTraversal(int index);
    void postorderTraversal(const std::vector<RealmShaper>& tree, int index, std::vector<std::string>& result);
    ...
    bool contains(RealmShaper* realmShaper);
};
